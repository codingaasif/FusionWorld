...
//     validateNameOnCard(event.target.value);
//   };
...
//   // handleCardNumberChange validation start
...
//   // handleCardCVVChange validation start
...
//     if (
//       validateUpiId(
//         upiId || (isValidCVV(cardCVV) && isValidCardNumber(cardNumber))
//       )
//     ) {
//       // Proceed with payment
//     } else {
//       setUpiError("Please enter a valid UPI ID before proceeding.");
//     }
...
//       setModalOpen(false); // Close the modal after successful order placement
//     } else {
//       setUpiError("Please enter a valid UPI ID before proceeding."); // Set error message for invalid UPI ID
//     }
//   };
...
//                 disabled={
//                   (!!upiError || !upiId) && (!!cardCVVError || !cardCVV)
//                 }
//               >
//                 Pay Now
//               </Button>
